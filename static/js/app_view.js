    ...
    "56d7": function(e, t, n) {
        ...
        h = (n("99af"), n("a434"), {
            ...
            mounted: function() {
                ...
                this.axios.get("http://159.75.2.47:9999/ebook/list/info").then((function(t) {
            ...
            methods: {
                ...
                handleEdit: function(e, t) {
                    ...
                    this.axios.put("http://159.75.2.47:9999/ebook/list/update/" + t.id, {
                        status: !t.status
                    }).then((function() {
                ...
                handleDelete: function(e, t) {
                    axios.defaults.withCredentials = true
                    var n = this;
                    this.axios.delete("http://159.75.2.47:9999/ebook/list/delete/" + t).then((function() {
                ...
                handleAdd: function() {
                    var e = this;
                    axios.defaults.withCredentials = true
                    "" != this.newTitle ? (this.axios.post("http://159.75.2.47:9999/ebook/list/add", {
                        title: this.newTitle
                    }).then((function(t) {
                        console.log("code:",t.data.Code)
                        if (t.data.Code == 2){
